...
const buttonVariants = cva(
  "mac1-button inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none",
  {
    variants: {
      variant: {
        default: "bg-white text-black hover:bg-black hover:text-white",
        destructive: "bg-white text-black hover:bg-black hover:text-white",
