...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none transition-[transform,box-shadow,background-color] duration-150",
  {
    variants: {
      variant: {
        ...
        "retro-minted":
          "bg-[#8B8680] text-white border-2 border-[#2D2A26] rounded-lg font-bold uppercase tracking-wide shadow-[2px_2px_0_#2D2A26] cursor-default",
      },
      size: {
