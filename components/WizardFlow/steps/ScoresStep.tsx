    ...
    <div className="flex flex-col min-h-full space-y-4 sm:space-y-8 pt-4 sm:pt-0">
      ...
      <div>
        <div className="flex items-center justify-between mb-2 sm:mb-3">
          <h3 className="uppercase text-lg sm:text-base font-bold text-[#2D2A26] tracking-wide">
            SSA Index
          </h3>
      ...
      {!isLoading && (
        <div>
          <h3 className="uppercase text-lg sm:text-base font-bold text-[#2D2A26] tracking-wide mb-3 mt-4 sm:mb-4">
            Provider Scores
          </h3>
          <div className="space-y-3 sm:space-y-4 divide-y divide-[#2D2A26]/40">
            ...
            {scores?.neynar && (
              <div className="space-y-1 pb-3">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm text-[#2D2A26] font-mono w-14">
              ...
              <>
                {[1, 2, 3, 4, 5, 6].map((i) => (
                  <div key={i} className="flex items-center gap-2 sm:gap-3 animate-pulse">
                    ...
                    <div className="w-16 sm:w-20 h-4 bg-[#E8E3DB] rounded" />
                    <div className="w-10 sm:w-14 h-4 bg-[#E8E3DB] rounded" />
                    <div className="flex-1 h-3 sm:h-4 bg-[#E8E3DB] rounded" />
                    <div className="w-8 sm:w-10 h-4 bg-[#E8E3DB] rounded hidden sm:block" />
                  </div>
                ))}
              </>
            )}
